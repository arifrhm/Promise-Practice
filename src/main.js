...
searchButton.addEventListener('click', function() {
    ...
    fetch('https://newsapi.org/v2/everything?q=Apple&from=2022-03-24&sortBy=popularity&apiKey=f14a4c4312d0401eb354cd0d3739f8f1' + inputKeyword.value)
...
const url = 'https://newsapi.org/v2/top-headlines?country=us&apiKey=f14a4c4312d0401eb354cd0d3739f8f1';
fetch(url) //404 error
     .then( res => {
          if (res.ok) {
                return res.json( );
